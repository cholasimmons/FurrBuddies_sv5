    ...
    <section class="flex justify-center mt-2">
        <div class="flex-grow flex flex-col max-w-lg justify-center">
            ...
            <form onsubmit={addBuddy}>
                ...
                <button onclick={()=>document.getElementById('uploader')?.click()} id="imagePreview" aria-label="Pet photo"
                ...
                <input type="file" id="uploader" bind:value={$ffile.value} style="display:none" accept="image/*" onchange={handleFileUpload} />
                ...
                <div class="mt-6 flex justify-between items-center">
                    <button disabled={!$addPetForm.dirty} onclick={addPetForm.reset} type="reset">
                        Clear Form
                    </button>
