...
<main class="px-{data.padding}">
    ...
    <h3 class="title hidden justify-between items-center ">
        ...
        <!-- Right Panel -->
        <div class="flex items-center gap-2">
            <button class="btn-icon btn-sm " type="button" aria-label="Filter items"><iconify-icon icon="mdi:filter"></iconify-icon></button>
            <button class="btn-icon btn-sm " type="button" aria-label="Arrange items"><iconify-icon icon="mdi:grid"></iconify-icon></button>
        </div>
    </h3>
