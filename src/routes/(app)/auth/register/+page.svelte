<script lang="ts">
    ...
    const signup = async () => {
        ...
        try {
            _registering = true;
            await appstate.signup($femail.value, $fpassword.value, $fname.value);
    ...
    async function submitPrefs(phoneNumber: number|undefined, gender: string|undefined) {
        await appstate.updateUserPrefs({'phoneNumber': phoneNumber, 'gender': gender})
    }
        ...
        <div class="flex-grow flex flex-col max-w-lg justify-center">
            ...
            <!-- Optional -->
                ...
                <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-x-4">
                    ...
                    <!-- User Phone Number (Optional) -->
                        ...
                        <input id="phoneNumber" type="tel" oninput={validateNumericInput} bind:value="{$fphone.value}"
            ...
            <!-- Form Buttons (Clear Form & Submit) -->
                ...
                <div class="mt-6 flex justify-between items-center">
                    <button disabled={!$registrationForm.dirty} onclick={registrationForm.reset} type="reset">
                        Clear Form
                    </button>
